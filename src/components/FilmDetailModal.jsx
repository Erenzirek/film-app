      ...
      <div className="row g-4">
        <div className="col-md-3 d-flex justify-content-center">
          <img
            ...
            style={{ maxWidth: '180px', width: '100%', objectFit: 'cover', maxHeight: '270px', marginBottom: '20px' }}
          />
        </div>
        ...
        <div className="col-md-9">
          ...
          <div className="text-muted mb-2 fs-5">
            <span>{film.releaseDate?.split('-')[0]}</span> • Directed by{' '}
            <strong className="text-primary">{film.director || ''}</strong>
          </div>

          <div
            className="fst-italic text-uppercase text-secondary mb-3 ps-3 border-start border-danger border-3"
